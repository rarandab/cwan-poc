...
- [x] 1. Add inspection_type input variable





  - [x] 1.1 Create inspection_type variable in variables.tf


    - Add variable with type string, default "fake_firewall"
    - Add validation block to restrict values to "fake_firewall" or "network_firewall"
    - _Requirements: 1.1, 1.2, 1.3, 1.4_
  - [ ]* 1.2 Write property test for inspection type validation
    - **Property 2: Invalid Inspection Type Rejection**
    - **Validates: Requirements 1.4**

- [x] 2. Add conditional logic to existing GWLB resources





  - [x] 2.1 Update fake_firewall module instantiation with conditional for_each


    - Modify for_each to only create resources when inspection_type == "fake_firewall"
    - _Requirements: 1.1_
  - [x] 2.2 Update GWLB endpoint resources with conditional for_each
    ...
    - _Requirements: 1.1_
  - [x] 2.3 Update GWLB-related routes with conditional for_each
...
- [-] 3. Implement Network Firewall rule group
  ...
  - [x] 3.1 Create stateful rule group resource for ICMP and HTTP
  ...
  - [x] 3.2 Write property test for rule group completeness
...
- [x] 4. Implement Network Firewall policy





  - [x] 4.1 Create firewall policy resource
...
- [ ] 5. Implement Network Firewall and endpoints
  - [x] 5.1 Create Network Firewall resource
    ...
    - _Requirements: 4.1_
  - [x] 5.2 Add locals for extracting firewall endpoint IDs
...
- [ ] 6. Implement Network Firewall routing
  - [x] 6.1 Create routes from Cloud WAN subnets to firewall endpoints
    ...
    - _Requirements: 4.2_
  - [x] 6.2 Create return routes from firewall subnets to NAT Gateway
...
- [x] 7. Implement Network Firewall logging





  - [x] 7.1 Create CloudWatch Log Group for firewall alerts
    ...
    - _Requirements: 5.1_
  - [x] 7.2 Create logging configuration resource
...
- [x] 9. Update documentation and outputs





  - [x] 9.1 Update terraform.tfvars with inspection_type example


    - Add commented example showing both options
    - _Requirements: 1.1, 1.2, 1.3_
  - [x] 9.2 Add Network Firewall outputs to outputs.tf
